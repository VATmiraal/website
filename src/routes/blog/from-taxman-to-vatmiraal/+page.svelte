...
<article id="page">
	<header id="hero">
		<h1>From TAXMAN to VATmiraal: Fifty Years of Teaching Machines the Law</h1>
		<p id="meta">5 min read &middot; March 2026</p>
	</header>
	...
	<a id="back-blog" href={resolve('/blog')}>&larr; All posts</a>
</article>

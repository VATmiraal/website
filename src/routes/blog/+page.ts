...
const fallbackReadingTimes: Record<string, number> = {
	'introducing-vatmiraal': 2,
	'from-taxman-to-vatmiraal': 6
};
...
export async function load() {
	...
	return {
		posts: articles.map((a) => ({ ...a, readingTime: fallbackReadingTimes[a.slug] ?? 0 }))
	};
}
